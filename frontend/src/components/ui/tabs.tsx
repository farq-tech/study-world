...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center rounded-xl bg-gray-100 p-1 text-gray-500 gap-1',
      className
    )}
    {...props}
  />
